...
name_dic = np.loadtxt("../gibbs_dataset/dataset_path_txt/transfer_similar/name_dic_1DK.txt", delimiter="\n", dtype='S' )

dir = "../gibbs_dataset/similar/dataset_A/1DK_8" 
...
for i in range(DATA_NUM):
    ...
    if(i >= 0 and i <= 14) or (i >=105 and i <= 119):
        position_list[0].append(position)
    if(i >= 15 and i <= 29) or (i >= 120 and i <= 134):
        position_list[1].append(position)
    if(i >= 30 and i <= 44) or (i >= 135 and i <= 149):
        position_list[2].append(position)
    if(i >= 45 and i <= 59) or (i >= 150 and i <= 164):
        position_list[3].append(position)
    if(i >= 60 and i <= 74) or (i >= 165 and i <= 179):
        position_list[4].append(position)
    if(i >= 75 and i <= 89) or (i >= 180 and i <= 194):
        position_list[5].append(position)
    if(i >= 90 and i <= 104) or (i >= 195 and i <= 209):
...
while per <= MAX_PER:
    ...
    name_vector = np.array([1,0,0,0,0,0,0,0]) #read correct name label of test data and make vector having elements of name
    idx = 0
    ...
    #=========================================================
    name_vector = np.array([0,1,0,0,0,0,0,0]) #read correct name label of test data and make vector having elements of name
    idx = 1
    ...
    #=========================================================
    name_vector = np.array([0,0,1,0,0,0,0,0]) #read correct name label of test data and make vector having elements of name
    idx = 3
    ...
    #=========================================================
    name_vector = np.array([0,0,0,1,0,0,0,0]) #read correct name label of test data and make vector having elements of name
    idx = 6
    ...
    #=========================================================
    name_vector = np.array([0,0,0,0,1,0,0,0]) #read correct name label of test data and make vector having elements of name
    idx = 2
    ...
    #=========================================================
    name_vector = np.array([0,0,0,0,0,1,0,0]) #read correct name label of test data and make vector having elements of name
    idx = 4
    ...
    #=========================================================
    name_vector = np.array([0,0,0,0,0,0,1,0]) #read correct name label of test data and make vector having elements of name
    idx = 5
    ...
    #=========================================================
    name_vector = np.array([0,0,0,0,0,0,0,1]) #read correct name label of test data and make vector having elements of name
    idx = 3
    ...
    ave_global = sum_global / 6
    ave_local = sum_local / 1
